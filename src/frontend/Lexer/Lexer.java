...
public class Lexer {
    ...
    private Token treatSign() {
        ...
        switch (ch) {
            case ':':
                return new Token(":", TokenType.COLON, curline);
            case '?':
                return new Token("?", TokenType.QUERY, curline);
            case '+':
                nextChar = peek();
                if (nextChar == '=') {
                    ch = getNextChar();
                    return new Token("+=", TokenType.PE, curline);
                } else if (nextChar == '+') {
                    ch = getNextChar();
                    return new Token("++", TokenType.PP, curline);
                } else {
            ...
            case '-':
                ...
                if (nextChar == '=') {
                    ch = getNextChar();
                    return new Token("-=", TokenType.SE, curline);
                } else {
            ...
            case '*':
                ...
                if (nextChar == '=') {
                    ch = getNextChar();
                    return new Token("*=", TokenType.ME, curline);
                } else {
            ...
            case '%':
                ...
                if (nextChar == '=') {
                    ch = getNextChar();
                    return new Token("%=", TokenType.MODE, curline);
                } else {
            ...
            case '/':
                ...
                if (nextChar == '/' || nextChar == '*') {
                    ...
                    ch = getNextChar();
                    return new Token("/=", TokenType.DE, curline);
                } else {
