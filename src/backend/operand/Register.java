...
public class Register implements Operand {
    ...
    public Register(RegisterType reg, Integer number) {
        this.reg = reg;
        this.number = number;
    ...
    public final static Register PC = new Register(RegisterType.PC, 32);

    public final static Register HI = new Register(RegisterType.HI, 33);
    public final static Register LO = new Register(RegisterType.LO, 34);
